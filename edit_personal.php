...
if (isset($_FILES['imageUp'])) {
    ...
    if (Update_option_personal($table)) {
        exit("Настрока сохранена");
    } else {
        exit("Ошибка сохраненения");
    }
...
if (isset($_POST['strToupdate'])) {
    ...
    if (update_str_option($table)) {
        ...
        $arr = [
            ...
            "vacant" => $options[$_POST["id"]]["vacant"],
            "education" => $options[$_POST["id"]]["education"],
            "experience" => $options[$_POST["id"]]["experience"],
                    ...
                    <div class="row">
                        <div class="col-12 pl-5 pb-2 justify-content-end ">
                            <ul class="breadcrumb justify-content-end my-0 py-0" style="background-color: #f1f3f7;">
                                ...
                                <li class="breadcrumb-item actve"><a href="#" class="text-muted">Сотрудники компании</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 pl-5 pb-2">
                            <b><strong>Сотрудники компании</strong></b>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($options as $option) : ?>
                                                    <tr class="tr" id="<?= $option['id'] ?>">
                                                        ...
                                                        <td>
                                                            <div class="edit" data-id="<?= $option['id'] ?>" data-name="vacant" contenteditable><?= $option['vacant'] ?></div>
                                                        </td>
                                                        <td>
                                                            <div class="edit" data-id="<?= $option['id'] ?>" data-name="education" contenteditable><?= $option['education'] ?></div>
                                                        </td>
                                                        <td>
                                                            <div class="edit" data-id="<?= $option['id'] ?>" data-name="experience" contenteditable><?= $option['experience'] ?></div>
                                                        </td>
                                                        <td>
    ...
    <div class="modal fade" id="ModalTypet">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <form id="UpForm">
                    <div class="modal-header">
                        <h5 class="modal-title">Изменение профиля сотрудника</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-6 justify-content-center">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="Up_vacant"></label>Занимаемая должность:</label>
                                                <input type="text" name="Up_vacant" data-name="Up_vacant" class="form-control" id="Up_vacant" placeholder="Введите должность" aria-describedby="Up_vacantHelp" value="">
                                                <small id="Up_vacantHelp"></small>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="Up_education"></label>Образование:</label>
                                                <input type="text" name="Up_education" data-name="Up_education" class="form-control" id="Up_education" placeholder="Введите образование" aria-describedby="Up_educationHelp" value="">
                                                <small id="Up_educationHelp"></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-row justify-content-center">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="Up_experience"></label>Стаж:</label>
                                        <input type="text" name="Up_experience" data-name="Up_experience" class="form-control" id="Up_experience" placeholder="Введите стаж" aria-describedby="Up_experienceHelp" value="">
                                        <small id="Up_experienceHelp"></small>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
    ...
    <div class="modal fade" id="AddModal">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <form id="AddForm">
                    <div class="modal-header">
                        <h5 class="modal-title">Создание профиля сотрудника</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="form-row">
                                <div class="col-6" id="Add_output">
                                    <!-- будем очищать содержимое и присваивать новое, такое-же, но с нов.фотографией |ИЛИ| изменять значение атребута src на имя -->
                                    <img name="Add_photo" id="Add_photo" data-name="Add_photo" class="img-fluid responsive image mx-auto d-block img-thumbnail" style=" width: 100% \9; min-height: 300px; max-height: 300px;" height="300px" src="img/User-avatar2.png" alt="Аватарка пользователя">
                                </div>

                                <!-- ДЛЯ ОТОБРАЖЕНИЯ В МУЛЯЖЕ В ФОРМЕ МОДЮОКНА ЕСТЬ "СКРЫТЫЙ IMG СО СВОИМИ СТИЛЯМИ -->
                                <div style="display: none;" class="col-6" id="outputNone">
                                    <!-- будем очищать содержимое и присваивать новое, такое-же, но с нов.фотографией |ИЛИ| изменять значение атребута src на имя -->
                                    <img name="Add_photo2" id="Add_photo2" data-name="Add_photo2" class="edit img-fluid responsive image mx-auto d-block img-thumbnail" style=" width: 100% \9; max-height: 100px;" src="img/User-avatar2.png" alt="Аватарка пользователя">
                                </div>
                                ...
                                <div class="col-6 justify-content-center">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="Add_surname"></label>Фамилия:</label>
                                                <input type="text" name="Add_surname" data-name="Add_surname" class="form-control" id="Add_surname" placeholder="Введите фамилию" aria-describedby="Add_surnameHelp" value="">
                                                <small id="Add_surnameHelp"></small>
                                            </div>
                                        </div>
                                        <div class="col-12 justify-content-center">
                                            <div class="form-group">
                                                <label for="Add_first_name"></label>Имя:</label>
                                                <input type="text" name="Add_first_name" data-name="Add_first_name" class="form-control" id="Add_first_name" placeholder="Введите имя" aria-describedby="Add_first_nameHelp" value="">
                                                <small id="Add_first_nameHelp"></small>
                                            </div>
                                        </div>
                                        <div class="col-12 justify-content-center">
                                            <div class="form-group">
                                                <label for="Add_last_name"></label>Отчество:</label>
                                                <input type="text" name="Add_last_name" data-name="Add_last_name" class="form-control" id="Add_last_name" placeholder="Введите отчество" aria-describedby="Add_last_nameHelp" value="">
                                                <small id="Add_last_nameHelp"></small>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="Add_vacant"></label>Занимаемая должность:</label>
                                                <input type="text" name="vacant" data-name="Add_vacant" class="form-control" id="Add_vacant" placeholder="Введите должность" aria-describedby="Add_vacantHelp" value="">
                                                <small id="Add_vacantHelp"></small>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="Add_education"></label>Образование:</label>
                                                <input type="text" name="Add_education" data-name="Add_education" class="form-control" id="Add_education" placeholder="Введите образование" aria-describedby="Add_educationHelp" value="">
                                                <small id="Add_educationHelp"></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-row py-1 pr-5">
                                <div class="col-6 ">
                                    <form enctype="multipart/form-data">
                                        <input id="Add_file" class="rounded" data-name="Add_avatar" type="file" name="Add_avatar" value="Выбрать фото">
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="form-row justify-content-center">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="Add_experience"></label>Стаж:</label>
                                        <input type="text" name="Add_experience" data-name="Add_experience" class="form-control" id="Add_experience" placeholder="Введите стаж" aria-describedby="Add_experienceHelp" value="">
                                        <small id="Add_experienceHelp"></small>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="Add_telephone"></label>Телефон:</label>
                                        <input type="text" name="Add_telephone" data-name="Add_telephone" class="form-control" id="Add_telephone" placeholder="Введите телефон" aria-describedby="Add_telephoneHelp" value="">
                                        <small id="Add_telephoneHelp"></small>
                                    </div>
                                </div>
                            </div>
